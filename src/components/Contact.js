...
import {Breadcrumb , BreadcrumbItem, FormGroup , Label , Button , Form  , Input , Col , Row , FormFeedback} from 'reactstrap'
                    ...
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <FormGroup row>
                            ...
                            <Col md={{size : 4 , offset  : 2}}>
                              <Input type="select" name="contactType" value={this.state.constactType}
                              onChange={this.handleInputChange}
                              >
                              <option>Tel.</option>
                              <option>Email</option>  
