  ...
  render() {
    ...
    <React.Fragment>
      <Navbar dark expand="md">
        <div className="container">
          <NavbarToggler onClick={this.toggleNav}/>
            ...
            <Collapse navbar isOpen={this.state.isOpenNav}>
            <Nav navbar>
          <NavItem>
      ...
      <Nav className="ml-auto" navbar>
        <NavItem>
          <Button outline onClick={this.toggleModel}><span className="fa fa-sign-in fa-lg"></span>  Sign In</Button>
        </NavItem>
      </Nav>
      </Collapse>
        </div>
      ...
      <Jumbotron>
       ...
       <Modal isOpen={this.state.isModelOpen} toggle={this.toggleModel}>
         <ModalHeader toggle={this.toggleModel}>Sign In</ModalHeader>
         <ModalBody>
